...
<html lang="en">
    <head>
        ...
        <title>Sistem Informasi Jalan dan Jembatan</title>
                ...
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-transparent navbar-dark fixed-top">
                        <div class="container px-5">
                            <a class="navbar-brand text-white" href="index.html">SI JANTAN</a>
                        ...
                        <div class="page-header-ui-content pt-10">
                            <div class="container px-5">
                                <div class="row gx-5 align-items-center">
                                    ...
                                    <div class="col-lg-6 d-none d-lg-block" data-aos="fade-up" data-aos-delay="100"><img class="img-fluid" src="{{ asset('') }}assets/images/windows.svg" /></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container px-5">
                            <div class="row gx-5 text-center">
                                <div class="col-lg-4 mb-5 mb-lg-0">
                                    ...
                                    <p class="mb-0">Lebih lengkap dan terpadu sehingga dapat dimanfaatkan dalam perencanaan dan pelaksanaan pembangunan jalan dan jembatan.</p>
                                </div>
                                <div class="col-lg-4 mb-5 mb-lg-0">
                                    <div class="icon-stack icon-stack-xl bg-gradient-primary-to-secondary text-white mb-4"><i data-feather="smartphone"></i></div>
                                    <h3>Akurat, Cepat, Dinamis</h3>
                                    <p class="mb-0">Sarana layanan data dan informasi yang lebih akurat, cepat, dinamis dan sesuai dengan tuntutan teknologi.</p>
                                </div>
                                <div class="col-lg-4">
                                    <div class="icon-stack icon-stack-xl bg-gradient-primary-to-secondary text-white mb-4"><i data-feather="code"></i></div>
                                    <h3>Mempermudah Pengambilan Kebijakan</h3>
                                    <p class="mb-0">Memudahkan semua pemangku kepetingan dalam proses pembangunan dan pengambilan kebijakan.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container px-5">
                            <div class="row gx-5 align-items-center justify-content-center">
                                ...
                                <div class="col-lg-6 order-0 order-lg-1 mb-5 mb-lg-0" data-aos="fade-left">
                                    <div class="mb-5">
                                        <h2>Tentang SI JANTAN</h2>
                                        <p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac volutpat sapien, sit amet feugiat nibh. Suspendisse nec lectus ligula. Donec sollicitudin augue nibh, non tristique sapien maximus vel. Praesent iaculis at lacus in egestas. In hac habitasse platea dictumst. Integer tempor mi et fringilla mattis. Curabitur placerat nisi dui, ac lacinia neque dictum et. Aliquam aliquet scelerisque lectus, ac posuere urna egestas at. Integer in fringilla risus. </p>
                                    </div>
                                    {{-- <div class="row gx-5">
    ...
    {{-- <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317" integrity="sha512-euoFGowhlaLqXsPWQ48qSkBSCFs3DPRyiwVu3FjR96cMPx+Fr+gpWRhIafcHwqwCqWS42RZhIudOvEI+Ckf6MA==" data-cf-beacon='{"rayId":"8294f79178e56bfa","version":"2023.10.0","token":"6e2c2575ac8f44ed824cef7899ba8463"}' crossorigin="anonymous"></script> --}}
</body>
</html>
