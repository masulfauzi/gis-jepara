            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-10 offset-lg-2">
                        <div class="row">
                            <div class='col-lg-2'><p>Jenis Survey</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $survey->jenisSurvey->id }}</p></div>
									...
									<div class='col-lg-2'><p>Panjang</p></div><div class='col-lg-10'><p class='fw-bold'>{{ $survey->panjang }}</p></div>
